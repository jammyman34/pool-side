        ...
        [
            ...
            ScenarioDefinition(
                ...
                steps: [
                    .generate(expect: .init(
                        treatmentCount: 1,
                        treatments: [.init(nameContains: "Liquid Chlorine 12.5%", amount: 0.75, unit: "gal", urgency: .recommended, badge: "Test before swimming", category: .swimBlocking, completionState: .plannedTreatment)],
                        v2State: .doNotSwim,
